...
## 05. Backward Propogation
![Image](https://github.com/ayushbagahe/Building-Neural-Network-From-Scratch-Using-Numpy/blob/main/backward_propagation.png)
Backward propagation is like a coach reviewing a game to help the team improve. After the team plays a match, the coach analyzes the mistakes and traces them back to specific players and decisions. In a neural network, after making a prediction, the system calculates the error and works backward through each layer. It determines how much each weight and bias contributed to the error and adjusts them to do better next time. This process helps the network learn from its mistakes and improve accuracy over time.
